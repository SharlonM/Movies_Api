...
public class CartazActivity extends AppCompatActivity implements listaAdapter.ItemFilmeClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configAdapter();
        bottomNavigator();
        progressBar = findViewById(R.id.progressCartaz);
        Toolbar toolbar = findViewById(R.id.toolbarCartaz);
                ...
                .enqueue(new Callback<Filmes_Generos>() {
                    ...
                    public void onResponse(Call<Filmes_Generos> call, Response<Filmes_Generos> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(CartazActivity.this, "Erro ao obter generos", Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    private void showError() {
        Toast.makeText(CartazActivity.this, "Erro ao obter filmes", Toast.LENGTH_LONG).show();
    }
